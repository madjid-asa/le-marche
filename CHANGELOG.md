...
## [2024.2.0](https://github.com/madjid-asa/le-marche/compare/v2025.3.0...v2024.2.0) (2025-05-11)


### Features

* Action admin pour l'anonymisation des utilisateurs ([#1624](https://github.com/madjid-asa/le-marche/issues/1624)) ([0dc2970](https://github.com/madjid-asa/le-marche/commit/0dc2970078a56df4405e8668b91000779105c69a))
* **Activités des structures:** Adaptation de l'affichage des secteurs d'activités des structures ([#1517](https://github.com/madjid-asa/le-marche/issues/1517)) ([fa792d0](https://github.com/madjid-asa/le-marche/commit/fa792d02a1a1de128cdedc408c3a5c64670b0c2d))
* **Activités des structures:** Adaptation de la recherche des Siaes ([#1519](https://github.com/madjid-asa/le-marche/issues/1519)) ([b3a57e8](https://github.com/madjid-asa/le-marche/commit/b3a57e8cdd997468f62b9955a18995b220d1a6df))
* **Activités des structures:** Ajout du choix du périmètre d'intervention aux niveaux des activités ([#1457](https://github.com/madjid-asa/le-marche/issues/1457)) ([8dc6f66](https://github.com/madjid-asa/le-marche/commit/8dc6f662abac378d3ee11ce1e886eb17ad383708))
* **Activités des structures:** Déplacement du matching sur les activités ([#1464](https://github.com/madjid-asa/le-marche/issues/1464)) ([b197675](https://github.com/madjid-asa/le-marche/commit/b197675a0cf8e639fb7a69193e6c97a1e292c20e))
* **Activités des structures:** Remplacement de l'onglet "Votre référencement" ([#1505](https://github.com/madjid-asa/le-marche/issues/1505)) ([273a11b](https://github.com/madjid-asa/le-marche/commit/273a11b865cdc32149063178ea7dfcc2bdbf81a2))
* **Admin des Besoins:** Demande de modification ou clôture d'un besoin  ([#1596](https://github.com/madjid-asa/le-marche/issues/1596)) ([e4bc06b](https://github.com/madjid-asa/le-marche/commit/e4bc06b6caae8505089270645f189f480ede70e2))
* **admin_tenders:** Rediriger vers la section structures après la validation des DDB ([#1111](https://github.com/madjid-asa/le-marche/issues/1111)) ([e29a3d4](https://github.com/madjid-asa/le-marche/commit/e29a3d43b6291cab0bf9d965a7fe6ff1f1792647))
* **Admin:** Ajout d'un filtre pour retrouver les dépôts de besoins incrémentaux ([#1090](https://github.com/madjid-asa/le-marche/issues/1090)) ([e53be2c](https://github.com/madjid-asa/le-marche/commit/e53be2ce566c911548fc1bb15a8ddd1de94e7fd4))
* **Admin:** Ajout de 'contact_phone' dans la recherche ([#1575](https://github.com/madjid-asa/le-marche/issues/1575)) ([2dff083](https://github.com/madjid-asa/le-marche/commit/2dff0830c369304c2c2db3df4e477e297584c4b9))
* **Admin:** Désactivation du bouton "Valider" si aucune SIAE ne correspond ([#1689](https://github.com/madjid-asa/le-marche/issues/1689)) ([0dac772](https://github.com/madjid-asa/le-marche/commit/0dac772e60ebecdaac8d7c1420a0cb8b05501d30))
* **Admin:** Secteurs : afficher le nombre de besoins concernés ([#1118](https://github.com/madjid-asa/le-marche/issues/1118)) ([8674309](https://github.com/madjid-asa/le-marche/commit/8674309a229f30b657f2ae50f721b74889ea564d))
* Ajout d'attributs dans Brevo pour les structures ([#1513](https://github.com/madjid-asa/le-marche/issues/1513)) ([f41f5c5](https://github.com/madjid-asa/le-marche/commit/f41f5c52b51808eb921f370aa5a5022be1a7dfdb))
* Ajout d'attributs de contact pour les acheteurs inscrits ([#1468](https://github.com/madjid-asa/le-marche/issues/1468)) ([e508900](https://github.com/madjid-asa/le-marche/commit/e5089008f713531b01b925cbafb3d4fbc03f68a6))
* ajout d'un attribut id sur les liens du bandeau pour suivre l'usage ([#1168](https://github.com/madjid-asa/le-marche/issues/1168)) ([9f37452](https://github.com/madjid-asa/le-marche/commit/9f37452f24e2573a45643d91e41d8e26fa5b2f82))
* Ajout d'un attribut pour filtrer l'envoi des besoins d'achat ([#1446](https://github.com/madjid-asa/le-marche/issues/1446)) ([d074709](https://github.com/madjid-asa/le-marche/commit/d07470904981fc4fdfaddcd811130a9faf1ece94))
* Ajout d'un bandeau pour inciter les structures à visiter leur page d'accueil ([#1157](https://github.com/madjid-asa/le-marche/issues/1157)) ([3d29098](https://github.com/madjid-asa/le-marche/commit/3d29098d118f8be8b7db6e04f1299337f4134971))
* Ajout d'un module django de guide pas à pas des utilisateurs ([#1315](https://github.com/madjid-asa/le-marche/issues/1315)) ([227f455](https://github.com/madjid-asa/le-marche/commit/227f455451e9a1ce4f589143c9f51a4f00f5620f))
* Ajout d'un sitemap ([#1450](https://github.com/madjid-asa/le-marche/issues/1450)) ([6895348](https://github.com/madjid-asa/le-marche/commit/68953481080dbc63aaa9e4cab47d10ef779c357a))
* Ajout de la page FAQ dans le footer ([#1649](https://github.com/madjid-asa/le-marche/issues/1649)) ([cda59af](https://github.com/madjid-asa/le-marche/commit/cda59af8995bca7d39b8662adb5875e16cdffe28))
* ajouter le tri des activités dans l'admin par date de modification ([1db3999](https://github.com/madjid-asa/le-marche/commit/1db399932dc524898e37636634a95f061b412cf2))
* API pour le service Datacube ([#1160](https://github.com/madjid-asa/le-marche/issues/1160)) ([24868e4](https://github.com/madjid-asa/le-marche/commit/24868e49502bac5f3d17d0790c53323cbd9d614d))
* **API Swagger:** Possibilité d'ajouter son token dans Swagger  ([#1695](https://github.com/madjid-asa/le-marche/issues/1695)) ([9fb0c76](https://github.com/madjid-asa/le-marche/commit/9fb0c7630caf00e9026da1bc060bd9959377673f))
* Authentification obligatoire sur l'API ([#1628](https://github.com/madjid-asa/le-marche/issues/1628)) ([7ac41ff](https://github.com/madjid-asa/le-marche/commit/7ac41ffe6ae3432a309eaced23de52c4e1352fe6))
* **Besoin:** Ajout d'un template de mail transactionnel quand le besoin est suivi par un partenaire commercial ([#1533](https://github.com/madjid-asa/le-marche/issues/1533)) ([4939bf0](https://github.com/madjid-asa/le-marche/commit/4939bf02a559177897eb539ec752e57f6d1f11ac))
* **Besoins:** Admin : Avoir le status de la mise en relation ([#1121](https://github.com/madjid-asa/le-marche/issues/1121)) ([9b5926c](https://github.com/madjid-asa/le-marche/commit/9b5926c0aef4f950ad69760c9148436d1a2ed462))
* **Besoins:** Admin : Connaitre le nombre de besoins déposés par chaque entreprise ([#1120](https://github.com/madjid-asa/le-marche/issues/1120)) ([9181d37](https://github.com/madjid-asa/le-marche/commit/9181d37d7399c276b4c5ee50361b8c0d4017a7d3))
* **Besoins:** Admin : filtre de la liste par bizdev ([#1134](https://github.com/madjid-asa/le-marche/issues/1134)) ([078b95a](https://github.com/madjid-asa/le-marche/commit/078b95a40c5d91eeb690e2aee005ca125a618a52))
* **Besoins:** Admin: afficher la liste des structures intéressées ([#1131](https://github.com/madjid-asa/le-marche/issues/1131)) ([9e801e9](https://github.com/madjid-asa/le-marche/commit/9e801e92989e15809fa892a4bfa23bc774237ba1))
* **Besoins:** Admin: afficher les utilisateurs qui ont vu le besoin ([#1151](https://github.com/madjid-asa/le-marche/issues/1151)) ([a543999](https://github.com/madjid-asa/le-marche/commit/a543999f36579e6e78ccd370360cc81b9e397656))
* **Besoins:** Admin: pouvoir indiquer quelle structure a effectivement transactionnée ([#1133](https://github.com/madjid-asa/le-marche/issues/1133)) ([7438756](https://github.com/madjid-asa/le-marche/commit/74387568638691c154cdbb83e99855b9b4fae6e8))
* **Besoins:** Ajout d'un filtre par type de besoin ([#1104](https://github.com/madjid-asa/le-marche/issues/1104)) ([d2054a6](https://github.com/madjid-asa/le-marche/commit/d2054a6eeb3cf41f4dd2919ee4f6f79e4a9358e0))
* **Besoins:** Ajout du nombre d'occurences en status Nouveau sur le filtre par type ([#1117](https://github.com/madjid-asa/le-marche/issues/1117)) ([feaf563](https://github.com/madjid-asa/le-marche/commit/feaf56369d5628fb6159f2c23bf10cb3c6600c46))
* **Besoins:** changement de couleur des badgets des besoins clôturés ([#1247](https://github.com/madjid-asa/le-marche/issues/1247)) ([ba48bc0](https://github.com/madjid-asa/le-marche/commit/ba48bc0fd6f1a7478afb5c1d28afd19109f0fdb8))
* **Besoins:** Connaitre la source de la transaction ([#1124](https://github.com/madjid-asa/le-marche/issues/1124)) ([1e9539f](https://github.com/madjid-asa/le-marche/commit/1e9539f05fa74b49e36003472cf9d7318b73510a))
* **Besoins:** Détail : afficher l'entreprise de l'acheteur en gras ([#1138](https://github.com/madjid-asa/le-marche/issues/1138)) ([2d6c3ab](https://github.com/madjid-asa/le-marche/commit/2d6c3abaeb47201af51657826153ca12e604fb7a))
* **Besoins:** Détail : mieux afficher l'email d'equipe ([#1137](https://github.com/madjid-asa/le-marche/issues/1137)) ([f090cbc](https://github.com/madjid-asa/le-marche/commit/f090cbcd6622371750c8f4490a751d9a38dea53e))
* **Besoins:** Détail : répare l'affichage de la modale d'inscription pour les utilisateurs inconnus ([#1136](https://github.com/madjid-asa/le-marche/issues/1136)) ([666513f](https://github.com/madjid-asa/le-marche/commit/666513f59213eaeeb2bcf2a5f63d772c5c94e40e))
* **Besoins:** Filtre par type de structure dans le ciblage des structures par recherche sémantique ([#1152](https://github.com/madjid-asa/le-marche/issues/1152)) ([d3a0e1a](https://github.com/madjid-asa/le-marche/commit/d3a0e1ae725af7d8a70e5942502f02e1a672bd33))
* **Besoins:** Formulaire : allège les restrictions sur le champ "lien externe" ([#1163](https://github.com/madjid-asa/le-marche/issues/1163)) ([18cdc1a](https://github.com/madjid-asa/le-marche/commit/18cdc1af4232141795611c0e37fdd1025086273b))
* **Besoins:** Formulaire : si un lien externe est fourni, alors forcer le choix de réponse ([#1164](https://github.com/madjid-asa/le-marche/issues/1164)) ([df05d51](https://github.com/madjid-asa/le-marche/commit/df05d517bcc6e85d08eb238261c531693820e592))
* **Besoins:** gérer le numéro de téléphone de contact avec une librairie dédiée (v2) ([#1224](https://github.com/madjid-asa/le-marche/issues/1224)) ([5df4a2d](https://github.com/madjid-asa/le-marche/commit/5df4a2d7bc9b8a741d5626e1e2d1cb961134000e))
* **Besoins:** Mesure du NPS des acheteurs ([#1119](https://github.com/madjid-asa/le-marche/issues/1119)) ([82e3e14](https://github.com/madjid-asa/le-marche/commit/82e3e14324186affa80f89e3c125b3d78493da74))
* **besoins:** méthode pour dupliquer un besoin ([#1097](https://github.com/madjid-asa/le-marche/issues/1097)) ([1c5a9ed](https://github.com/madjid-asa/le-marche/commit/1c5a9edcd85ec792f711378ebf0574ecd416660f))
* **Besoins:** mettre à jour automatiquement la date de transaction ([#1122](https://github.com/madjid-asa/le-marche/issues/1122)) ([4f502e7](https://github.com/madjid-asa/le-marche/commit/4f502e7ea5a0237479ac2bbbd1d5c2020fe2be67))
* **Besoins:** mettre à jour l'utilisateur de la mise en relation ([#1144](https://github.com/madjid-asa/le-marche/issues/1144)) ([0adc957](https://github.com/madjid-asa/le-marche/commit/0adc957c4c25883cb175b380b35e78443f71327a))
* **Besoins:** Mise à jour de la deuxième question pour la mesure d'impact ([#1296](https://github.com/madjid-asa/le-marche/issues/1296)) ([0e8c240](https://github.com/madjid-asa/le-marche/commit/0e8c2409001a21a4c0361a6f90b7479264c8b394))
* **Besoins:** Nouveau champ M2M 'admins' pour aider le suivi ([#1113](https://github.com/madjid-asa/le-marche/issues/1113)) ([e042239](https://github.com/madjid-asa/le-marche/commit/e0422390f0663172bd277904cef3f21dfddf12f2))
* **Besoins:** nouveau champ pour stocker la date de transaction ([#1116](https://github.com/madjid-asa/le-marche/issues/1116)) ([7c52702](https://github.com/madjid-asa/le-marche/commit/7c52702edd097471ca48d956f178d872d40631d5))
* **Besoins:** Ordonner les besoins par date de publication ([#1243](https://github.com/madjid-asa/le-marche/issues/1243)) ([aa0d005](https://github.com/madjid-asa/le-marche/commit/aa0d00591260bf9ab7ec336aea1f2aeeb59625d4))
* **Besoins:** Permettre à une structure contactée de décliner dès l'e-mail ([#1114](https://github.com/madjid-asa/le-marche/issues/1114)) ([fe8ec03](https://github.com/madjid-asa/le-marche/commit/fe8ec0300aa41908ad6cd221a63c6bf0d52ba5c6))
* **Besoins:** pouvoir rattacher un utilisateur à une mise en relation ([#1143](https://github.com/madjid-asa/le-marche/issues/1143)) ([a4e2f1f](https://github.com/madjid-asa/le-marche/commit/a4e2f1f766adaae1de271816f5c2fe38f9ee0dd2))
* **besoins:** Sondage aux prestataires intéressés : cron & task ([#1085](https://github.com/madjid-asa/le-marche/issues/1085)) ([d19f152](https://github.com/madjid-asa/le-marche/commit/d19f152a469a84fd1277cd5faebbd72147de44a8))
* **Besoins:** Sondage transaction : ajouter une option "Pas encore" ([#1154](https://github.com/madjid-asa/le-marche/issues/1154)) ([bf8a23d](https://github.com/madjid-asa/le-marche/commit/bf8a23dfcdbffd794822493bc69de6383af4a9cb))
* **Besoins:** Sondage transaction : mettre à jour le TenderSiae en fonction de la réponse ([#1139](https://github.com/madjid-asa/le-marche/issues/1139)) ([2e358ba](https://github.com/madjid-asa/le-marche/commit/2e358baa725ee721d5d8a4639cbf4b9c733c34c9))
* **Brevo:** à l'inscription d'un utilisateur Structure, ajouter à une liste ([#1210](https://github.com/madjid-asa/le-marche/issues/1210)) ([a91a735](https://github.com/madjid-asa/le-marche/commit/a91a735d52df18d345e8f8e510eae3fd54f81088))
* **Brevo:** après une recherche d'un acheteur, ajouter à une liste Brevo ([#1135](https://github.com/madjid-asa/le-marche/issues/1135)) ([ec146dc](https://github.com/madjid-asa/le-marche/commit/ec146dc199856b7a7644ad5f4f1e174a82e271ec))
* **Brevo:** Commande pour synchroniser toutes les semaines les entreprises (SIAE) ([#1106](https://github.com/madjid-asa/le-marche/issues/1106)) ([5880917](https://github.com/madjid-asa/le-marche/commit/5880917b59815a94252435745b88b22024d5b955))
* **Brevo:** lorsqu'un utilisateur se rattache à une structure, envoyer l'info à Brevo ([#1211](https://github.com/madjid-asa/le-marche/issues/1211)) ([f685d73](https://github.com/madjid-asa/le-marche/commit/f685d73547686ae90f4750335922b6b7dc5943e0))
* **Brevo:** méthode pour créer (et maj) des entreprises (SIAE) ([#1099](https://github.com/madjid-asa/le-marche/issues/1099)) ([1225a0c](https://github.com/madjid-asa/le-marche/commit/1225a0cad121df3eb6c26b037e121da5c4c8acb0))
* **Brevo:** méthode pour lier des Contacts (User) à une Company (Siae) ([#1209](https://github.com/madjid-asa/le-marche/issues/1209)) ([1aa7b99](https://github.com/madjid-asa/le-marche/commit/1aa7b99fbd0e712d8c302ed10e8c8b0c03c8af2b))
* Changement du nom du lien d'inscription sur l'accueil des structures ([#1156](https://github.com/madjid-asa/le-marche/issues/1156)) ([f65fcfa](https://github.com/madjid-asa/le-marche/commit/f65fcfabf065f170a555150360576c3ef1eaaf5b))
* Changer url de la page "Auditer vos achats" ([#1218](https://github.com/madjid-asa/le-marche/issues/1218)) ([3aaa04f](https://github.com/madjid-asa/le-marche/commit/3aaa04fda6122869efd63c10dfacdaa4b27e9de3))
* **cms:** ajout de page de FAQ sur le cms ([#1342](https://github.com/madjid-asa/le-marche/issues/1342)) ([9aaa614](https://github.com/madjid-asa/le-marche/commit/9aaa6140ee7e46f7c10d7c6750671da4520d7b5e))
* **cms:** modification cms du nombre de home page ([365fe91](https://github.com/madjid-asa/le-marche/commit/365fe916b87a46519a79cac8f1686072c24dad32))
* **contact:** Ajout de MTCaptcha sur le formulaire de contact ([#1096](https://github.com/madjid-asa/le-marche/issues/1096)) ([380e710](https://github.com/madjid-asa/le-marche/commit/380e710604970355ff9dfd55f16db344991e04f2))
* Conversations: anonymisation des données ([#1618](https://github.com/madjid-asa/le-marche/issues/1618)) ([4d65073](https://github.com/madjid-asa/le-marche/commit/4d650732beb750840b43d490f065d429bfbe65c6))
* **Conversations:** Suppression des données de prise de contacts après 6 mois ([#1027](https://github.com/madjid-asa/le-marche/issues/1027)) ([dfd2c0a](https://github.com/madjid-asa/le-marche/commit/dfd2c0a22cd6bc5a5c657a80e3e75925f47e4157))
* **crm:** Management commande de Synchronisation des utilisateurs avec Brevo ([#1178](https://github.com/madjid-asa/le-marche/issues/1178)) ([c4733e7](https://github.com/madjid-asa/le-marche/commit/c4733e77711d4b54d64500c455b66b511b3268dc))
* **Dashboard SIAE:** Réordonner les besoins (derniers publiés en premier) ([#1098](https://github.com/madjid-asa/le-marche/issues/1098)) ([df3fd2f](https://github.com/madjid-asa/le-marche/commit/df3fd2f3523007f732ed965b825ba02542b9a6fc))
* **DDB:** ajout d'un fragement wagtail pour info bulle des structures ([#1213](https://github.com/madjid-asa/le-marche/issues/1213)) ([8a5151c](https://github.com/madjid-asa/le-marche/commit/8a5151c7e5fa07fe52b53558e46fbdf1e89434ee))
* **DDB:** Possibilité d'ajouter des pièces jointes ([#1673](https://github.com/madjid-asa/le-marche/issues/1673)) ([53d2051](https://github.com/madjid-asa/le-marche/commit/53d2051780df3b9c6a4595d179e9f1a2c0509051))
* **Dépôt de besoins:** Ajout d'attributs pour le nouveaux process de suivi vip ([#1325](https://github.com/madjid-asa/le-marche/issues/1325)) ([9fb6b62](https://github.com/madjid-asa/le-marche/commit/9fb6b62132e030f27031720731415e04243913b3))
* **dépôt de besoins:** Ajout des dépôts de besoins sur Brevo (1/3) ([#1123](https://github.com/madjid-asa/le-marche/issues/1123)) ([5825776](https://github.com/madjid-asa/le-marche/commit/58257761209d1816d5eefe22e3f7af8e2232823c))
* **Dépôt de besoins:** envoi d'un email à l'auteur d'un dépôt de besoin avec 5 ESI ([#1167](https://github.com/madjid-asa/le-marche/issues/1167)) ([3775153](https://github.com/madjid-asa/le-marche/commit/3775153f6f480dfdc7c20eb3b737b135213a650c))
* **Dépôt de besoins:** Permettre aux structures de supprimer les dépôts de besoins expirés ([#1110](https://github.com/madjid-asa/le-marche/issues/1110)) ([4404359](https://github.com/madjid-asa/le-marche/commit/4404359a26bdaa3312660becc270df649a25a08a))
* **Dépôt de besoins:** renommer les titres d'emails pour ne pas avoir l'impression d'envoyer deux fois le même mail ([#1166](https://github.com/madjid-asa/le-marche/issues/1166)) ([f8f3d6c](https://github.com/madjid-asa/le-marche/commit/f8f3d6ce5bd90ffb0a5e4e732e8aadaa3809fcee))
* **Dépôts de besoins:** Synchroniser les DDB avec brevo à la validation  ([#1179](https://github.com/madjid-asa/le-marche/issues/1179)) ([b1495bf](https://github.com/madjid-asa/le-marche/commit/b1495bf6f86694e2b350dfb567ab588af7a08db9))
* Dynamisation du lien en bas du mail des tops ESI à l'auteur d'un besoin ([#1170](https://github.com/madjid-asa/le-marche/issues/1170)) ([d5ac41c](https://github.com/madjid-asa/le-marche/commit/d5ac41c1bcb7c9833c089bdf436e6c355afae2e1))
* **Email Notifications:** Ajout du formulaire d'édition des préférences ([#1595](https://github.com/madjid-asa/le-marche/issues/1595)) ([b50530a](https://github.com/madjid-asa/le-marche/commit/b50530afd8dd60d5e5d5f3939468e85a707c1cfa))
* **Email Notifications:** Mise à jour côté Brevo du choix pour les communications Marketing ([#1639](https://github.com/madjid-asa/le-marche/issues/1639)) ([f7b9c1a](https://github.com/madjid-asa/le-marche/commit/f7b9c1a48259338144a30113257d45852fd3ccd5))
* **Email Notifications:** Prise en compte de la désactivation d'un groupe d'email par un utilisateur ([#1630](https://github.com/madjid-asa/le-marche/issues/1630)) ([3bee0e0](https://github.com/madjid-asa/le-marche/commit/3bee0e0ce20ee69ab96f9e7137de682ae26987fe))
* **Emails:** avoir les logs d'envois des TemplateTransactional ([#1337](https://github.com/madjid-asa/le-marche/issues/1337)) ([3addac3](https://github.com/madjid-asa/le-marche/commit/3addac3deb5cf5fa3e8d59120a98447db8f70d31))
* **Emails:** Besoins : configurer les envois d'e-mails "avez-vous transactionné ?" avec TemplateTransactional (3/X) ([#1343](https://github.com/madjid-asa/le-marche/issues/1343)) ([fe3bb3b](https://github.com/madjid-asa/le-marche/commit/fe3bb3bc9e2f34d2c7a4832dccac54d51eac62e4))
* **Emails:** Besoins : configurer les envois d'e-mails à l'auteur avec TemplateTransactional (2/X) ([#1341](https://github.com/madjid-asa/le-marche/issues/1341)) ([c02db9f](https://github.com/madjid-asa/le-marche/commit/c02db9ff717131db83b5a31f06d693f266833613))
* **Emails:** Besoins : configurer les envois d'e-mails avec TemplateTransactional ([#1193](https://github.com/madjid-asa/le-marche/issues/1193)) ([d04efcb](https://github.com/madjid-asa/le-marche/commit/d04efcbb33f6951e2b8c5b73b7716d6e5c369c4a))
* **Emails:** pouvoir envoyer les e-mails transactionnels depuis TemplateTransactional ([#1034](https://github.com/madjid-asa/le-marche/issues/1034)) ([6836178](https://github.com/madjid-asa/le-marche/commit/683617823749a3df3a8f56147ee6cb9c4e6b913c))
* **Emails:** remplacer l'envoi de finalisation du compte par son TemplateTransactional ([#1019](https://github.com/madjid-asa/le-marche/issues/1019)) ([8db0c7f](https://github.com/madjid-asa/le-marche/commit/8db0c7fb6836bc82d2a46e31969b91f8da657bd6))
* **Emails:** Structures : configurer les envois d'e-mails avec TemplateTransactional ([#1189](https://github.com/madjid-asa/le-marche/issues/1189)) ([cf7201e](https://github.com/madjid-asa/le-marche/commit/cf7201ed0b27108724bb60c6f2e77478fc9dd025))
* **Entreprises:** commande interactive pour créer de nouvelles entreprises à partir des infos des acheteurs ([#1165](https://github.com/madjid-asa/le-marche/issues/1165)) ([e7c80af](https://github.com/madjid-asa/le-marche/commit/e7c80af14aea3950866a9ae885ee8aec6477534f))
* **Entreprises:** nouveau champ pour stocker le nombre d'acheteurs sur LinkedIn ([#1140](https://github.com/madjid-asa/le-marche/issues/1140)) ([1fd1fc3](https://github.com/madjid-asa/le-marche/commit/1fd1fc379c375e747fa213a1cc60242aa6de18ef))
* **Entreprises:** nouveau champ user_tender_count, nouvelle commande pour mettre les count à jour ([#1132](https://github.com/madjid-asa/le-marche/issues/1132)) ([a58f4af](https://github.com/madjid-asa/le-marche/commit/a58f4af6191ca8e0fba5a096e61249df7c585d61))
* factorisation d'un copié-collé ([#1640](https://github.com/madjid-asa/le-marche/issues/1640)) ([c9de2f2](https://github.com/madjid-asa/le-marche/commit/c9de2f29106655b3ea43d21562349c47348c037d))
* **Home:** La page d'accueil d'un utilisateur d'une structure doit être celle dédiée aux ESI ([#1172](https://github.com/madjid-asa/le-marche/issues/1172)) ([f2e75d6](https://github.com/madjid-asa/le-marche/commit/f2e75d6b313fc78d69f18d57fe5515019dc99006))
* **Home:** Rendre les sections de l'accueil davantage modifiable ([#1141](https://github.com/madjid-asa/le-marche/issues/1141)) ([551c39a](https://github.com/madjid-asa/le-marche/commit/551c39ae45c079cca171c3fc30c9d0821f9643ec))
* **inscription:** Lien direct vers la page des CGU sur le formulaire d’inscription ([#1262](https://github.com/madjid-asa/le-marche/issues/1262)) ([6d1a7a6](https://github.com/madjid-asa/le-marche/commit/6d1a7a61fd143e2a2cf187a7685093356743c7e9))
* Interdiction des mails personnels pour l'inscription des acheteurs ([#1677](https://github.com/madjid-asa/le-marche/issues/1677)) ([4af734a](https://github.com/madjid-asa/le-marche/commit/4af734abe8520faec2ed40ff47f012b3abf4bf1b))
* Menu déroulant "Mon espace" dans le header ([#1662](https://github.com/madjid-asa/le-marche/issues/1662)) ([e38f8a0](https://github.com/madjid-asa/le-marche/commit/e38f8a0340c170377312cc7ecc5374c3c83a4fb8))
* Prise de rendez vous à l'inscription ([#1663](https://github.com/madjid-asa/le-marche/issues/1663)) ([38c4219](https://github.com/madjid-asa/le-marche/commit/38c421915f10c4b8af3a23eedad6db443f9ebbe3))
* Répondre aux questions de la DDB ([#1668](https://github.com/madjid-asa/le-marche/issues/1668)) ([be12276](https://github.com/madjid-asa/le-marche/commit/be12276aaa2be2158776b03161b71926783ab6aa))
* Retirer la co-traitance ([#1623](https://github.com/madjid-asa/le-marche/issues/1623)) ([d3676d1](https://github.com/madjid-asa/le-marche/commit/d3676d161d3972745f4024fc18e9dd0e1b36e903))
* **SIAE:** nouveau champ 'extra_data' ([#1105](https://github.com/madjid-asa/le-marche/issues/1105)) ([047a321](https://github.com/madjid-asa/le-marche/commit/047a321c5547334ab75c2bf17b6d4607001ba8d8))
* **SIAE:** nouvelle property is_live ([#1107](https://github.com/madjid-asa/le-marche/issues/1107)) ([019cac8](https://github.com/madjid-asa/le-marche/commit/019cac8bd9531a5a952150c6a1011e224c211447))
* **Siae:** Permettre aux structures de changer leur nom commercial ([#1552](https://github.com/madjid-asa/le-marche/issues/1552)) ([9c32349](https://github.com/madjid-asa/le-marche/commit/9c32349e3761b0f23e539b7decbb034fb5cb229e))
* **SIAE:** script d'import des ESATs du fichier csv Gesat/Handeco ([#1216](https://github.com/madjid-asa/le-marche/issues/1216)) ([bfb1d28](https://github.com/madjid-asa/le-marche/commit/bfb1d28527fbad470a61a19078e74d59414c034f))
* **SIAE:** script d'import/mise à jour des SEP ([#1231](https://github.com/madjid-asa/le-marche/issues/1231)) ([fb50bc1](https://github.com/madjid-asa/le-marche/commit/fb50bc1a4de72cf2c40a36bfa30f76be528ab977))
* **SIAE:** script pour aider le rattachement à leur réseau (grâce à des import csv) ([#1109](https://github.com/madjid-asa/le-marche/issues/1109)) ([464cde5](https://github.com/madjid-asa/le-marche/commit/464cde563d3aa1c75e3788e0f92f35bf994a1e3b))
* statistiques sur la validité des numéros de téléphone ([#1219](https://github.com/madjid-asa/le-marche/issues/1219)) ([8279dab](https://github.com/madjid-asa/le-marche/commit/8279dabfafb2f29cadcff19b84150b3c0cb03632))
* **Structures:** gérer le numéro de téléphone de contact avec une librairie dédiée ([#1221](https://github.com/madjid-asa/le-marche/issues/1221)) ([4856276](https://github.com/madjid-asa/le-marche/commit/4856276125a140dd7abe22fcd400036c5790a960))
* **Structures:** historique de modification grâce à django-simple-history ([#1255](https://github.com/madjid-asa/le-marche/issues/1255)) ([146ade4](https://github.com/madjid-asa/le-marche/commit/146ade4ec50f969fddae8710576a5044c793c51c))
* **Structures:** nouveau champ pour stocker le brevo_company_id ([#1208](https://github.com/madjid-asa/le-marche/issues/1208)) ([046818f](https://github.com/madjid-asa/le-marche/commit/046818f29d59d8e99306b73df63a2e6fd0d2516e))
* **Structures:** Nouveau modèle SiaeActivity ([#1261](https://github.com/madjid-asa/le-marche/issues/1261)) ([e458851](https://github.com/madjid-asa/le-marche/commit/e45885119af12a5af20ef22fdcfd2a0099a00f95))
* **Structures:** pouvoir modifier une activité ([#1290](https://github.com/madjid-asa/le-marche/issues/1290)) ([af22ef4](https://github.com/madjid-asa/le-marche/commit/af22ef4da6c661a036d07435b4252b9e1f5c520a))
* **Structures:** Réindexation automatique des structures dans l'index Elasticsearch ([#1245](https://github.com/madjid-asa/le-marche/issues/1245)) ([ac3de01](https://github.com/madjid-asa/le-marche/commit/ac3de01cc5175e20bed53ac65f680592a900b6c3))
* **Structures:** SiaeActivity : afficher les activités dans la fiche ([#1308](https://github.com/madjid-asa/le-marche/issues/1308)) ([0c02ab9](https://github.com/madjid-asa/le-marche/commit/0c02ab9ba019882a32ff3da3d562ccf78d06cbee))
* **Structures:** SiaeActivity : commencer à afficher les activités dans un nouvel onglet du formulaire ([#1266](https://github.com/madjid-asa/le-marche/issues/1266)) ([59c5707](https://github.com/madjid-asa/le-marche/commit/59c5707766a36dee2e50d227a0f81eb7159b57ab))
* **Structures:** SiaeActivity : formulaire pour créer une nouvelle activité ([#1278](https://github.com/madjid-asa/le-marche/issues/1278)) ([c68edcb](https://github.com/madjid-asa/le-marche/commit/c68edcbdce1630f1c4ada3737e75d1a52738f924))
* **Structures:** SiaeActivity : pouvoir supprimer une activité ([#1277](https://github.com/madjid-asa/le-marche/issues/1277)) ([c65ff19](https://github.com/madjid-asa/le-marche/commit/c65ff19046cef229d5d6d143179f45c8cbcf759e))
* suppression de la limite du nombre de page d'accueil ([#1194](https://github.com/madjid-asa/le-marche/issues/1194)) ([7fb1759](https://github.com/madjid-asa/le-marche/commit/7fb175995a2e4399da30db19417aade81ddbdc02))
* suppression de la synchro c2 c4 ([#1633](https://github.com/madjid-asa/le-marche/issues/1633)) ([88c131e](https://github.com/madjid-asa/le-marche/commit/88c131edaa8f492f226b63539042bf5518aa088b))
* Suppression des données personnelles ([#1607](https://github.com/madjid-asa/le-marche/issues/1607)) ([ec4fbbf](https://github.com/madjid-asa/le-marche/commit/ec4fbbfc5caaa70110729be8683d13bb640891b7))
* Supprimer mailjet ([#1632](https://github.com/madjid-asa/le-marche/issues/1632)) ([cdc6634](https://github.com/madjid-asa/le-marche/commit/cdc6634366f90c0eccb7db2ce450899ad9fb8853))
* **tender:** Admin : réduire la taille de la page grâce aux collapse ([#1089](https://github.com/madjid-asa/le-marche/issues/1089)) ([8874279](https://github.com/madjid-asa/le-marche/commit/887427978b45c32a6c4a85d50e911da81e7c06e7))
* **Utilisateurs:** gérer le numéro de téléphone avec une librairie dédiée ([#1215](https://github.com/madjid-asa/le-marche/issues/1215)) ([fab59b8](https://github.com/madjid-asa/le-marche/commit/fab59b8bc94e1735ad014699e9989363568e86ef))
* Whitelist des ips de Brevo pour inbound emails ([#1620](https://github.com/madjid-asa/le-marche/issues/1620)) ([e33ed12](https://github.com/madjid-asa/le-marche/commit/e33ed1229724788a646d2c2849b96d52fcf40b84))


### Bug Fixes

* 'set' object is not subscriptable ([b83aecd](https://github.com/madjid-asa/le-marche/commit/b83aecd754e824249f84fec9c9367bfb436c91da))
* **Activités des structures:** Adaptation de la commande de reprise de stock pour créer les activités ([#1476](https://github.com/madjid-asa/le-marche/issues/1476)) ([9f497e6](https://github.com/madjid-asa/le-marche/commit/9f497e6ad52282b16512adc295810ce5058a70e1))
* **Activités des structures:** ajout de la correspondance directe sur la ville, le département ou la région de la structure ([#1487](https://github.com/madjid-asa/le-marche/issues/1487)) ([21e97c4](https://github.com/madjid-asa/le-marche/commit/21e97c428214e73c419e5ad0182cc19b2ace9636))
* **Activités des structures:** Ajustement des exceptions de la commande de reprise de stock pour créer les activités ([#1480](https://github.com/madjid-asa/le-marche/issues/1480)) ([b823940](https://github.com/madjid-asa/le-marche/commit/b8239402ddf64555d0d671b4e02a2f3214220b5a))
* **Activités des structures:** Correction de l'affichage des fiches structures sans type de prestation ([#1532](https://github.com/madjid-asa/le-marche/issues/1532)) ([810669e](https://github.com/madjid-asa/le-marche/commit/810669e19048b4a8c0d533c6eb9b19865e0cc509))
* **Activités des structures:** Correction du formulaire d'édition des activités ([#1625](https://github.com/madjid-asa/le-marche/issues/1625)) ([432d7a2](https://github.com/madjid-asa/le-marche/commit/432d7a256646bb5d410e1750907cbb6df4d93a82))
* add class to fix faq button ([#1346](https://github.com/madjid-asa/le-marche/issues/1346)) ([6d48f7f](https://github.com/madjid-asa/le-marche/commit/6d48f7fc427cf8b2a9745a2366057c57d5a63f77))
* add try/catch & tests on phone display. ref [#1234](https://github.com/madjid-asa/le-marche/issues/1234) ([cf6401c](https://github.com/madjid-asa/le-marche/commit/cf6401cebd146f9ad697ae6d925770d087c41d88))
* **Admin:** autoriser la suppression des SiaeUserRequest & TemplateTransactionalSendLog ([#1424](https://github.com/madjid-asa/le-marche/issues/1424)) ([c64e984](https://github.com/madjid-asa/le-marche/commit/c64e9848f2f4b47199178589dfc6b5ef181345bb))
* **Admin:** Besoins : répare le filtre par montant exact ([#1112](https://github.com/madjid-asa/le-marche/issues/1112)) ([31208bb](https://github.com/madjid-asa/le-marche/commit/31208bba82c0d7ae9f3976e656aa0db6ae8c9e6b))
* **Admin:** Besoins: ajuste les règles de filtrage pour le montant exact. ref [#1112](https://github.com/madjid-asa/le-marche/issues/1112) ([fa21009](https://github.com/madjid-asa/le-marche/commit/fa210093091f17b4bb392d42b77dd1df5749da87))
* **Admin:** Correction de la mise en page des cases à cochées ([#1466](https://github.com/madjid-asa/le-marche/issues/1466)) ([02fdbd5](https://github.com/madjid-asa/le-marche/commit/02fdbd5e7704de5bb2ab7e244be2a85d8d149122))
* Affichage du bandeau d'environnement ([#1648](https://github.com/madjid-asa/le-marche/issues/1648)) ([b71da26](https://github.com/madjid-asa/le-marche/commit/b71da263fb23e74ae1f5afe8b6b2e4b1286a8f98))
* Affichage du détail du dépôt de besoin ([#1515](https://github.com/madjid-asa/le-marche/issues/1515)) ([b0b3a70](https://github.com/madjid-asa/le-marche/commit/b0b3a706517442676fce76f2a18ff864fdfb3f12))
* Affichage du header droit de la liste des dépôt de besoins ([#1128](https://github.com/madjid-asa/le-marche/issues/1128)) ([df3b452](https://github.com/madjid-asa/le-marche/commit/df3b452c9260df54c44d45c482abf752f8d917a4))
* Ajout d'un label pour le type d'utilisateur ([#1667](https://github.com/madjid-asa/le-marche/issues/1667)) ([6f89c29](https://github.com/madjid-asa/le-marche/commit/6f89c290c553cc8e149b6a2b3d92b9c3878cfb6e))
* ajout des marges manquante en bas de page ([#1439](https://github.com/madjid-asa/le-marche/issues/1439)) ([e2c4783](https://github.com/madjid-asa/le-marche/commit/e2c478377315001d70a1f124023cc9a57780228f))
* Amélioration de la commande 'create_content_pages' ([#1545](https://github.com/madjid-asa/le-marche/issues/1545)) ([f4eefc8](https://github.com/madjid-asa/le-marche/commit/f4eefc8e5f2c8ba479606de26e200703b8148e2c))
* Amélioration de la validation des champs url ([#1565](https://github.com/madjid-asa/le-marche/issues/1565)) ([fb26956](https://github.com/madjid-asa/le-marche/commit/fb2695650b97d312c104f00569f0b41f33bbf9d3))
* **API QPV:** Adaptation suite à la suppression du champs "code_qv" ([#1316](https://github.com/madjid-asa/le-marche/issues/1316)) ([017afcf](https://github.com/madjid-asa/le-marche/commit/017afcfeae081ccb27c5a013ef9933dfb3ea92f5))
* **API:** Exclure les structures OPCS des résultats ([#1129](https://github.com/madjid-asa/le-marche/issues/1129)) ([b79133e](https://github.com/madjid-asa/le-marche/commit/b79133e49f202073e0db13d203aa5d43ed33afd2))
* **API:** mise à jour du lien vers api.gouv ([#1127](https://github.com/madjid-asa/le-marche/issues/1127)) ([b95885d](https://github.com/madjid-asa/le-marche/commit/b95885d40134e24d2dc08a2b167a3697893df4e0))
* **API:** Réparer le script de synchro avec les emplois ([#1023](https://github.com/madjid-asa/le-marche/issues/1023)) ([ad4e86e](https://github.com/madjid-asa/le-marche/commit/ad4e86ee24ab6e097e069058a1b8744e4310ca0c))
* **APProch:** Améliore le wording du bouton CTA des besoins provenant d'APProch. ref [#923](https://github.com/madjid-asa/le-marche/issues/923) ([9844546](https://github.com/madjid-asa/le-marche/commit/9844546b49fa530beb4eedb20d74046a36c55601))
* Autoriser seulement les "GET" sur PerimeterAutocompleteViewSet ([#1615](https://github.com/madjid-asa/le-marche/issues/1615)) ([848df37](https://github.com/madjid-asa/le-marche/commit/848df37fda048107621c3b30374833df1b1dd256))
* **Besoins:** Admin : filtre vraiment la liste des utilisateurs sur les bizdev ([#1242](https://github.com/madjid-asa/le-marche/issues/1242)) ([8a46774](https://github.com/madjid-asa/le-marche/commit/8a467745ba47ef64bff38f51a942fd6513c350e7))
* **Besoins:** Admin : restreindre la liste des admins affichés (bizdev only). ref [#1242](https://github.com/madjid-asa/le-marche/issues/1242) ([a58e122](https://github.com/madjid-asa/le-marche/commit/a58e122dc4902b2d5e64e5edc1487e347a027d45))
* **Besoins:** améliore la définition d'un besoin non dépassé ([#1176](https://github.com/madjid-asa/le-marche/issues/1176)) ([617704e](https://github.com/madjid-asa/le-marche/commit/617704ea1a7be2c6f1b771f8a9f87f6bb245151b))
* **Besoins:** arrête l'envoi par batch lorsque la date de clotûre du besoin est dépassée ([#1175](https://github.com/madjid-asa/le-marche/issues/1175)) ([bf1a8ff](https://github.com/madjid-asa/le-marche/commit/bf1a8ff0f070bd2f5132bffaca858879ce56f71d))
* **Besoins:** Correction sur le nombre d'occurrences en status Nouveau sur le filtre par type ([#1126](https://github.com/madjid-asa/le-marche/issues/1126)) ([6bc052b](https://github.com/madjid-asa/le-marche/commit/6bc052b5d1608b587a350c92cad4338f97ee4d00))
* **Besoins:** évite d'envoyer des mails de relance aux structures pas intéressées ([#1158](https://github.com/madjid-asa/le-marche/issues/1158)) ([ffd6704](https://github.com/madjid-asa/le-marche/commit/ffd6704a91b6f5e789cb8a28429d8e3d4792ef03))
* **Besoins:** Exclure les structures OPCS du matching ([#1130](https://github.com/madjid-asa/le-marche/issues/1130)) ([b0fb1c9](https://github.com/madjid-asa/le-marche/commit/b0fb1c91bda4ad4a11a464b13dc6c9cfd45e0cbd))
* **Besoins:** ne pas autoriser le ré-envoi si la date de clôture est dépassée ([#1177](https://github.com/madjid-asa/le-marche/issues/1177)) ([780245b](https://github.com/madjid-asa/le-marche/commit/780245bd94509f29c24fced2e4aca4e3d61f435a))
* **Besoins:** réduit le nombre de mails de relances envoyés aux structures concernées ([#1161](https://github.com/madjid-asa/le-marche/issues/1161)) ([7a56950](https://github.com/madjid-asa/le-marche/commit/7a56950aab732873557228dea114cea40475dc9d))
* **Besoins:** répare l'ouverture au clic de 2 liens dfférents ([#1148](https://github.com/madjid-asa/le-marche/issues/1148)) ([f8b741e](https://github.com/madjid-asa/le-marche/commit/f8b741e6415e8f79c47ccea7c710d0d393d25209))
* **Brevo:** Admin : afficher les identifiants (contact_id, deal_id, company_id) ([#1228](https://github.com/madjid-asa/le-marche/issues/1228)) ([90eaaed](https://github.com/madjid-asa/le-marche/commit/90eaaed926040eb0332ba4946b3eb7341a005386))
* **Brevo:** Améliorer le script de synchro des structures vers Brevo ([#1229](https://github.com/madjid-asa/le-marche/issues/1229)) ([76b35c3](https://github.com/madjid-asa/le-marche/commit/76b35c3bed83731bc7634866bd160a51bb05fb66))
* **Brevo:** AttributeError in 'api_brevo.create_contact' ([#1594](https://github.com/madjid-asa/le-marche/issues/1594)) ([84c637c](https://github.com/madjid-asa/le-marche/commit/84c637ccd0a31f3363ad06d8ee8a2bc362a9709e))
* **Brevo:** Mieux gérer la mises à jour des contacts Brevo (et envoyer le téléphone) ([#1230](https://github.com/madjid-asa/le-marche/issues/1230)) ([539d00f](https://github.com/madjid-asa/le-marche/commit/539d00f45270f78ac93d097b1532566f406a4a3c))
* **Brevo:** mieux gérer le rattachement des contact avec leur company / deal ([#1212](https://github.com/madjid-asa/le-marche/issues/1212)) ([1daf3b8](https://github.com/madjid-asa/le-marche/commit/1daf3b85f8747e3a5d9b14cb593e6915f4dbf3a9))
* **Brevo:** synchro des utilisateurs sans Tender ([#1592](https://github.com/madjid-asa/le-marche/issues/1592)) ([1c8be5f](https://github.com/madjid-asa/le-marche/commit/1c8be5f4f3b8398af6d77ec0c0ee76f2f9ae6460))
* **Brevo:** update_enabled arg in 'api_brevo.create_contact' ([#1593](https://github.com/madjid-asa/le-marche/issues/1593)) ([b7b1c04](https://github.com/madjid-asa/le-marche/commit/b7b1c0465c7f38b4224cef6712a15fc87294fc47))
* bug sur les gestionnaires sur Admin ([#1638](https://github.com/madjid-asa/le-marche/issues/1638)) ([55cac40](https://github.com/madjid-asa/le-marche/commit/55cac40569c36b82268e63af96cf625e7d0172dc))
* bug sur les secteurs dans l'API des SIAE ([#1669](https://github.com/madjid-asa/le-marche/issues/1669)) ([afd1a1b](https://github.com/madjid-asa/le-marche/commit/afd1a1b34d864b92bdd9f5e895177b145e6b5fb5))
* Changement de conditions de synchronisation des DDB vers le crm brevo ([#1622](https://github.com/madjid-asa/le-marche/issues/1622)) ([393f227](https://github.com/madjid-asa/le-marche/commit/393f227e3b3f21e3615445799a2dbcebdd9258e6))
* **CI:** affiche mieux les diff dans le script de déploiement. ref [#1063](https://github.com/madjid-asa/le-marche/issues/1063) ([6f014b3](https://github.com/madjid-asa/le-marche/commit/6f014b301fa3e8fc667b805718203866e19fc30a))
* **ci:** Typo dans la config auto-assign-reviewers. ref [#1265](https://github.com/madjid-asa/le-marche/issues/1265) ([608a2b8](https://github.com/madjid-asa/le-marche/commit/608a2b84ef81cd0020b35f37831a5a14eeb0313d))
* **Collaborateurs:** Correction du rattachement des collaborateurs sur certains navigateurs ([#1655](https://github.com/madjid-asa/le-marche/issues/1655)) ([9a019bd](https://github.com/madjid-asa/le-marche/commit/9a019bd0ddac723e40d433f61b396103c640fad2))
* Condition invalide pour échapper le CSRF ([#1616](https://github.com/madjid-asa/le-marche/issues/1616)) ([d35c21d](https://github.com/madjid-asa/le-marche/commit/d35c21d3a0527d3cb54cd837b6b88800b15d6931))
* **Contact:** fix de l'url sur la page de contact ([30120b2](https://github.com/madjid-asa/le-marche/commit/30120b25f405f83b6e45155b1eb734b7baddd6c9))
* Copie de django-fieldsets-with-inlines ([#1657](https://github.com/madjid-asa/le-marche/issues/1657)) ([92ce844](https://github.com/madjid-asa/le-marche/commit/92ce8443741b1bb10f159c9a2773545ae9465e3b))
* Correction au niveau des logos d'entête ([#1538](https://github.com/madjid-asa/le-marche/issues/1538)) ([443dc3f](https://github.com/madjid-asa/le-marche/commit/443dc3fd086971803e75dab7afb8ce28921b179c))
* Correction de l'affichage des cases à cocher des secteurs d'activités ([#1467](https://github.com/madjid-asa/le-marche/issues/1467)) ([a06e89a](https://github.com/madjid-asa/le-marche/commit/a06e89a73f308cdeaaeb6c549707ef65a94f6157))
* correction typo du badge super prestataire ([2c84271](https://github.com/madjid-asa/le-marche/commit/2c84271e1958155b624ca4b735ff2556f63e1993))
* **Dashboard Acheteurs:** correction d'un onglet et des multiselects ([#1465](https://github.com/madjid-asa/le-marche/issues/1465)) ([71cb6cd](https://github.com/madjid-asa/le-marche/commit/71cb6cd311e88a49423058b34c6fb67be6008227))
* **dashboard_siae:** fix du bug d'affichage des tabs pour compléter les données des siaes ([#1093](https://github.com/madjid-asa/le-marche/issues/1093)) ([bc91e10](https://github.com/madjid-asa/le-marche/commit/bc91e1070c5d9354b2fb5b563b69a2f9d51018f4))
* **Dépôt de besoin:** Réparation du badge de clôture ([#1125](https://github.com/madjid-asa/le-marche/issues/1125)) ([af0bd82](https://github.com/madjid-asa/le-marche/commit/af0bd823965a5a15f48c461415e0412d8e640385))
* doubles imports alpineJs ([#1670](https://github.com/madjid-asa/le-marche/issues/1670)) ([2023316](https://github.com/madjid-asa/le-marche/commit/20233161b6cd4afc6a0076beec6052501cdb7cb4))
* duplication des siae dans l'API ([#1674](https://github.com/madjid-asa/le-marche/issues/1674)) ([5236a55](https://github.com/madjid-asa/le-marche/commit/5236a5570b4ac9bddabca7b98ebcedaafdec31fa))
* **Email:** Retour sur l'enregistrement du log avant envoi ([#1629](https://github.com/madjid-asa/le-marche/issues/1629)) ([65a2fe6](https://github.com/madjid-asa/le-marche/commit/65a2fe6653007257732df4365c1063f0726a201d))
* **Emails:** ajout de valeur par défaut pour subject ([#1205](https://github.com/madjid-asa/le-marche/issues/1205)) ([59f2497](https://github.com/madjid-asa/le-marche/commit/59f249736c913ab50796e7acf1fbb286de3db85e))
* **Emails:** ajout de valeurs par défaut pour from_email & from_name ([#1204](https://github.com/madjid-asa/le-marche/issues/1204)) ([ad2bbc0](https://github.com/madjid-asa/le-marche/commit/ad2bbc09e99ca243d17c08e0ea0fdf796d9bd873))
* **Emails:** Template Transactional: remove result() call ([#1379](https://github.com/madjid-asa/le-marche/issues/1379)) ([1809f5c](https://github.com/madjid-asa/le-marche/commit/1809f5cb102042d13eb8284aa0493f6e3a29b6ee))
* **Entreprises:** ajuste le script de rattachement des utilisateurs en fonction de leur email (ajoute un @) ([#1406](https://github.com/madjid-asa/le-marche/issues/1406)) ([daebacf](https://github.com/madjid-asa/le-marche/commit/daebacf126a644b99cd2247677002f388fc78a17))
* erreur sur une variable non définie. ref [#1102](https://github.com/madjid-asa/le-marche/issues/1102) ([ecadcd0](https://github.com/madjid-asa/le-marche/commit/ecadcd011f0511cc36a2b1f042a68202ec4c27fc))
* Erreurs de serialisation des inbound email ([#1619](https://github.com/madjid-asa/le-marche/issues/1619)) ([987b044](https://github.com/madjid-asa/le-marche/commit/987b04484948484015c564b9d795ce60383829ae))
* extra email variable refactoring. ref [#1337](https://github.com/madjid-asa/le-marche/issues/1337) ([5a1ae57](https://github.com/madjid-asa/le-marche/commit/5a1ae5780f2278e544e658645b78b8c8a191cfa8))
* fix dsfr des champs géré via AutoCompleteAccessible ([#1481](https://github.com/madjid-asa/le-marche/issues/1481)) ([6107675](https://github.com/madjid-asa/le-marche/commit/6107675f79154d0bf412b90d099313f4b81529ee))
* Fix du nom et prénom dans la synchronisation des contacts avec Brevo ([#1311](https://github.com/madjid-asa/le-marche/issues/1311)) ([e7c1ef5](https://github.com/madjid-asa/le-marche/commit/e7c1ef5a475928a9bdc63438878eb6ee621ac989))
* fix queryset filtering for tender author survey reminder. ref [#1057](https://github.com/madjid-asa/le-marche/issues/1057) ([1d8777a](https://github.com/madjid-asa/le-marche/commit/1d8777a64503727ab07161a6aba881c1d61dfe7c))
* Fix template overload ([#1658](https://github.com/madjid-asa/le-marche/issues/1658)) ([a82ca6e](https://github.com/madjid-asa/le-marche/commit/a82ca6e66e092b3364da20beebef448693fae557))
* Flacky test causé par un mot de passe aléatoire non valide ([#1621](https://github.com/madjid-asa/le-marche/issues/1621)) ([561c066](https://github.com/madjid-asa/le-marche/commit/561c06693615b5553ac48d65d666685eac7c010a))
* forgot last contact_phone_display. ref [#1234](https://github.com/madjid-asa/le-marche/issues/1234) ([f88fd90](https://github.com/madjid-asa/le-marche/commit/f88fd90a8250601ffffa480ed0bd21f766ed9a45))
* **History:** update requirements.txt. ref [#1255](https://github.com/madjid-asa/le-marche/issues/1255) ([3d79ce1](https://github.com/madjid-asa/le-marche/commit/3d79ce1dc31d6f06263281e3b377fea987fa350d))
* **Hubspot:** Répare la création de contact (suite au changement de format du numéro de téléphone) ([#1232](https://github.com/madjid-asa/le-marche/issues/1232)) ([bdfd7a1](https://github.com/madjid-asa/le-marche/commit/bdfd7a1754e3561a940d0a9ef97aedc129ea7260))
* **Import des emplois:** exclusion du type OPCS de l'import ([#1603](https://github.com/madjid-asa/le-marche/issues/1603)) ([67a64ab](https://github.com/madjid-asa/le-marche/commit/67a64ab509dd0cd14188f84d0ecc42f27361dc32))
* **import:** Correction sur l'import des numéros de téléphone  ([#1237](https://github.com/madjid-asa/le-marche/issues/1237)) ([b352489](https://github.com/madjid-asa/le-marche/commit/b352489ce1cb0546ccc0748fdb01cb87ec06bff7))
* **Inbound parsing:** Correction du serialiser et ajout de logs ([#1700](https://github.com/madjid-asa/le-marche/issues/1700)) ([0496a2d](https://github.com/madjid-asa/le-marche/commit/0496a2d2f013de178e5dbd4735103c9214cdf410))
* L'image de la section Ecosystème ne change pas ([#1149](https://github.com/madjid-asa/le-marche/issues/1149)) ([fe2ae2d](https://github.com/madjid-asa/le-marche/commit/fe2ae2deb0012244a33ef284b91e4dc8c4c77a65))
* Le logout doit se faire en POST ([#1656](https://github.com/madjid-asa/le-marche/issues/1656)) ([c723eb1](https://github.com/madjid-asa/le-marche/commit/c723eb1ff62ddf7de3fdfcc19615bf5a0d27ca5b))
* **Liste des dépôts de besoin:** Correction d'une erreur javascript pour éviter un bug sur la liste ([#1574](https://github.com/madjid-asa/le-marche/issues/1574)) ([8532546](https://github.com/madjid-asa/le-marche/commit/8532546557dbb81db1445403a0c8004bafee8434))
* Methode save() supprimée de l'admin des besoins ([#1665](https://github.com/madjid-asa/le-marche/issues/1665)) ([b48b680](https://github.com/madjid-asa/le-marche/commit/b48b6802674b3fa9b56a0ab5c01b1454d5679bdf))
* Migration de l'authentification de token vers un middleware + Sauvegarde des anciennes clés d'apis ([#1531](https://github.com/madjid-asa/le-marche/issues/1531)) ([f37debf](https://github.com/madjid-asa/le-marche/commit/f37debf5b8d1e43c3caa4095343ce6f046c1e27b))
* Migrer les presta_type vide des activités ([#1676](https://github.com/madjid-asa/le-marche/issues/1676)) ([7718fd3](https://github.com/madjid-asa/le-marche/commit/7718fd3f3f3a6dbd8e6945ec9f5d878e21cb09d9))
* mini fixs SEO de la page faq  ([#1351](https://github.com/madjid-asa/le-marche/issues/1351)) ([f527985](https://github.com/madjid-asa/le-marche/commit/f52798508fa2a15c1eddedc09afc0374090b9c3c))
* on TenderSiae survey_transaction answer, only update Tender if True. ref [#1124](https://github.com/madjid-asa/le-marche/issues/1124) ([14c2e05](https://github.com/madjid-asa/le-marche/commit/14c2e05436fb194a348f74a6575a3bd6db97109f))
* Prise en charge des ids malformés dans l'API des siae ([#1675](https://github.com/madjid-asa/le-marche/issues/1675)) ([c414da4](https://github.com/madjid-asa/le-marche/commit/c414da40736cecdc7b1e77c95cc7b5c0c9ff54c0))
* **Recherche:** Les champs multiselect ne doivent pas s'activer lorsqu'ils sont désactivés ([#1440](https://github.com/madjid-asa/le-marche/issues/1440)) ([ba0b379](https://github.com/madjid-asa/le-marche/commit/ba0b379dcdf87a981db9dc7ef466bdfa5c656538))
* Remove dependabot auto pr action ([#1612](https://github.com/madjid-asa/le-marche/issues/1612)) ([9925bcd](https://github.com/madjid-asa/le-marche/commit/9925bcd6c10f526e4796f46032b3f4078de4028e))
* Réparation du montant lors de la synchro avec Brevo ([#1470](https://github.com/madjid-asa/le-marche/issues/1470)) ([94e0680](https://github.com/madjid-asa/le-marche/commit/94e068013416cdda176ca8c3dc05c0df17bacfb9))
* Répare des tests qui cassent parfois ([#1147](https://github.com/madjid-asa/le-marche/issues/1147)) ([48fa4fe](https://github.com/madjid-asa/le-marche/commit/48fa4fe9cb703d9e9760a3068521b9787829102a))
* Répare encore des tests qui cassent parfois ([#1155](https://github.com/madjid-asa/le-marche/issues/1155)) ([84547bb](https://github.com/madjid-asa/le-marche/commit/84547bbf1c61858f90a543e9741a5b9c09387da4))
* Répare l'affichage des numéros de téléphone (suite au changement de format) ([#1234](https://github.com/madjid-asa/le-marche/issues/1234)) ([ae7d6e2](https://github.com/madjid-asa/le-marche/commit/ae7d6e2fd38c1ef10070481fd580f2756679b581))
* revert django-storages to 1.13.2. ref [#972](https://github.com/madjid-asa/le-marche/issues/972) ([595aaeb](https://github.com/madjid-asa/le-marche/commit/595aaebd3ea1613eca0e108003e865c6df332702))
* s3 storage fix in prod ([5a258a3](https://github.com/madjid-asa/le-marche/commit/5a258a30f013fd1ebd96799a57525139558661fe))
* **S3:** Correction de l'erreur d'envoi d'image dans l'admin Wagtail ([#1664](https://github.com/madjid-asa/le-marche/issues/1664)) ([a0b9b61](https://github.com/madjid-asa/le-marche/commit/a0b9b61a99224c6f92538ce834f43bb80389bedd))
* **Secteurs d'activités:** Mise à jour du calcul du nombre de secteurs pour le déduire des activités associées ([#1564](https://github.com/madjid-asa/le-marche/issues/1564)) ([7ab2f2a](https://github.com/madjid-asa/le-marche/commit/7ab2f2aee14b91a84dd2d02906bf03e7e98c668c))
* sectors_list_string replace by sector_groups_list_string on siae model ([0a27eca](https://github.com/madjid-asa/le-marche/commit/0a27eca8492249916e4c634755566c6f608a6409))
* **Session:** Stockage des sessions côté serveur ([#1270](https://github.com/madjid-asa/le-marche/issues/1270)) ([bc51057](https://github.com/madjid-asa/le-marche/commit/bc510575b00ece58f0a4120657f0acbb9b3454ea))
* **SIAE:** Evite que le champ is_delisted soit écrasé à chaque synchro avec les emplois ([#1108](https://github.com/madjid-asa/le-marche/issues/1108)) ([57a6093](https://github.com/madjid-asa/le-marche/commit/57a60939cffd28b1f06d41eadfa6c685130429ec))
* **siae:** répare la génération des Siae.kind constants ([#1087](https://github.com/madjid-asa/le-marche/issues/1087)) ([949cb4c](https://github.com/madjid-asa/le-marche/commit/949cb4cb7ea480b2177a90f96ee656e2671053f4))
* **Signup:** Rendre l'année dynamique dans le questionnaire pour les acheteurs lors de l'inscription ([#1284](https://github.com/madjid-asa/le-marche/issues/1284)) ([561d689](https://github.com/madjid-asa/le-marche/commit/561d689b1f4e536ee77804048ee0b0978e40ac16))
* **Structures:** afficher seulement aux admins l'information que la structure n'est pas encore inscrite ([#1239](https://github.com/madjid-asa/le-marche/issues/1239)) ([e26c47b](https://github.com/madjid-asa/le-marche/commit/e26c47bc96fe7bdc1f25859b0693bf1381c2166c))
* **Structures:** Correction sur le contrôle d'unicité du nom commercial ([#1606](https://github.com/madjid-asa/le-marche/issues/1606)) ([171abff](https://github.com/madjid-asa/le-marche/commit/171abff7a5c4aaaae933356a22768842eb2a33a3))
* **Structures:** Détail : améliorer les informations affichées aux admin ([#1238](https://github.com/madjid-asa/le-marche/issues/1238)) ([73dd4d9](https://github.com/madjid-asa/le-marche/commit/73dd4d9d3f9cfc52ac437c35efe848f86e7db001))
* **Structures:** fix refactoring array to string functions. ref [#1267](https://github.com/madjid-asa/le-marche/issues/1267) ([224ec11](https://github.com/madjid-asa/le-marche/commit/224ec117594b3aa6519fd460e0fa892e59146825))
* **Structures:** quelques améliorations d'affichage sur la page recherche & détails ([#1240](https://github.com/madjid-asa/le-marche/issues/1240)) ([20ee3d1](https://github.com/madjid-asa/le-marche/commit/20ee3d1f67107d818296e15dbef607138275a0c9))
* Suppression accidentelle du groupe d'activité "restauration" ([#1709](https://github.com/madjid-asa/le-marche/issues/1709)) ([0959bcb](https://github.com/madjid-asa/le-marche/commit/0959bcbebfd1c0a96af97a30b35a522998d0a16e))
* **tender:** Suppression de l'affichage du badge "Nouveau" sur les DDB clôturés ([#1088](https://github.com/madjid-asa/le-marche/issues/1088)) ([239a5d5](https://github.com/madjid-asa/le-marche/commit/239a5d523131e99a0f40a13a55def587710ec5dd))
* **Tracker:** errors linked to user_id ([e309d59](https://github.com/madjid-asa/le-marche/commit/e309d598800acfb735cdf46b6b5016678d10f1f0))
* Uniformisation de la hauteur des blocs du carousel ([#1223](https://github.com/madjid-asa/le-marche/issues/1223)) ([ec96cb6](https://github.com/madjid-asa/le-marche/commit/ec96cb674978477426eb4000da9b5d11a0989585))
* value error recherche prestataire =&gt; passage django 4.2 => 5.1 ([#1635](https://github.com/madjid-asa/le-marche/issues/1635)) ([f1196c7](https://github.com/madjid-asa/le-marche/commit/f1196c722f0dd20decfb982537d9ba6f1d61f242))
* **wagtail:** add csrf trusted origins to fix wagtail preview ([#1276](https://github.com/madjid-asa/le-marche/issues/1276)) ([1d31350](https://github.com/madjid-asa/le-marche/commit/1d31350175996d7a38943fc090a056a54293d7f9))
* Widget de secteurs d'activité buggé dans la page de signup ([#1660](https://github.com/madjid-asa/le-marche/issues/1660)) ([a776105](https://github.com/madjid-asa/le-marche/commit/a776105755b6ab22d7a52876175aaf856a1b7ec9))
* wrong GET ids ([#1636](https://github.com/madjid-asa/le-marche/issues/1636)) ([3047b38](https://github.com/madjid-asa/le-marche/commit/3047b38ed243ce9e60ab93a586314352a3e05ffd))
